...
@section('content')
<h4 class="title_page">Thêm công việc</h4>
<div class="row">
    ...
    <div class="col-sm-8">
        ...
        <form action="task/add" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" placeholder="Nhập tên công việc" name="name">
            </div>
            <div class="form-group">
                <label>Nội dung</label>
                    <input type="text" class="form-control" placeholder="Nhập nội dung công việc" name="content_task">
            </div>
            <div class="form-group">
